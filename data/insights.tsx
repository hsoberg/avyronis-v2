...
export const insights: InsightArticle[] = [
...

  {
    ...
    description: "Alt du trenger å vite om lokal SEO i Norge — Google Maps, anmeldelser, landingssider og NAP-konsistens. Praktisk guide for småbedrifter som vil bli synlige i lokale søk.",
    excerpt: "Alt du trenger å vite for å bli synlig i lokale søk — Google Maps, anmeldelser og landingssider.",
