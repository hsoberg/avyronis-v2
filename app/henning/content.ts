...
export const content: Record<Lang, HenningContent> = {
  no: {
    ...
    heroLine1: 'AI skal ikke erstatte tenkingen.',
    heroLine2: 'Det skal utvide hva du er i stand til å bygge.',
    heroBody: 'Det er slik jeg jobber: Jeg kombinerer research, produktforståelse, kreativitet, teknologi og menneskelig vurdering — og bruker AI til å gå raskere fra et reelt problem til noe som kan testes, brukes og forbedres.',
    ...
    processHeading: 'AI er ikke snarveien. Det er en del av arbeidsmåten.',
  ...
  en: {
    ...
    heroLine1: 'AI should not replace the thinking.',
    heroLine2: 'It should expand what you are capable of building.',
    heroBody: 'That is how I work: I combine research, product thinking, creativity, technology and human judgement — using AI to move faster from a real problem to something that can be tested, used and improved.',
    ...
    processHeading: 'AI is not the shortcut. It is part of the way I work.',
