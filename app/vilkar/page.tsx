export default function Vilkar() {
  return (
    <main style={{padding: '2rem 0'}}>
      ...
      <p>Ved å bruke avyronis.no godtar du følgende vilkår:</p>
      <ul>
        <li>Nettsiden tilbys «som den er» uten garantier.</li>
        <li>Innholdet er kun til informasjonsformål og kan endres uten varsel.</li>
